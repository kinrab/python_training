...
def test_del_first_contact(app):
    ...
    if app.contact.count() == 0:
        ...
        user_contact =  Contact( first_name = "Сидоров",
                                             middle_name = "Сидор",
                                             last_name = "Сидорович",
                                             nick_name= "Сидор",
                                             contact_title =  "ССС",
    ...
    old_contact_list [0:1] = []   # Удаляем элемент с индексом index из списка
...
def test_del_some_contact(app):
    ...
    old_contact_list [index:index+1] = []   # Удаляем элемент с индексом index из списка
